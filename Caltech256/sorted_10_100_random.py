...
'''
@Time    : 2021/7/16 18:01
@Author  : Qiushi Wang
@FileName: sorted_10_100_random.py
@Software: PyCharm
'''
...
easy_10_100 = sorted_loss[int(len(sorted_loss) * 0.1):]
...
#
# test = sorted_loss[int(len(sorted_loss)*0.9):]
label_file = './results/different_learning_method/random/labels.txt'
...
for index, item in enumerate(easy_10_100):
    ...
    save_path = './results/different_learning_method/random/images/' + str(int(index)) + '.jpg'
