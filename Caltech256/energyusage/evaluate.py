...
# -----------------------------------Running the process and measuring wattage----------------
    ...
    return (process_kwh, return_value,gpu_process_average,gpu_baseline_average, watt_averages, files, total_time, time_baseline, reading_baseline_wattage, time_process, reading_process_wattage)
...
locations=["Mongolia", "Iceland", "Switzerland"], year="2016", printToScreen = True):
    ...
    try:
        ...
        if (utils.valid_cpu() or utils.valid_gpu()):
            ...
            result, return_value,gpu_process_average,gpu_baseline_average, watt_averages, files, total_time, time_baseline, reading_baseline_wattage, time_process, reading_process_wattage = energy(user_func, *args, powerLoss = powerLoss, year = year, \
            ...
            '''
            print(gpu_process_average)
            print(gpu_baseline_average)
            if energyOutput:
