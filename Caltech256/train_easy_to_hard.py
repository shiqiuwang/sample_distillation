...
'''
@Time    : 2021/7/16 10:44
@Author  : Qiushi Wang
@FileName: train_easy_to_hard.py
@Software: PyCharm
'''
...
from my_dataset_for_easy_to_hard import NewRMBDataset
import time
...
train_dir = "./results/different_learning_method/easy_to_hard/images"
# valid_dir = "./results/confusion_dataset/0_10"
valid_dir = "./data/caltech_split_data/valid"
# valid_dir = "./results/confusion_dataset/40_50"
...
# 构建MyDataset实例
train_data = NewRMBDataset(data_dir=train_dir, transform=train_transform)
...
# 将结果写入文本
with open(file='./results/different_learning_method/easy_to_hard/result/valid_acc.txt', mode='w+',
          encoding='utf-8') as f1:
    for val in valid_acc:
        f1.write(str(val))
        f1.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/valid_precision.txt', mode='w+',
          encoding='utf-8') as f2:
    for val in valid_precision:
        f2.write(str(val))
        f2.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/valid_recall.txt', mode='w+',
          encoding='utf-8') as f3:
    for val in valid_recall:
        f3.write(str(val))
        f3.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/valid_f1.txt', mode='w+',
          encoding='utf-8') as f4:
    for val in valid_f1:
        f4.write(str(val))
        f4.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/valid_time_record.txt', mode='w+',
          encoding='utf-8') as f5:
    for val in time_record:
        f5.write(str(val))
        f5.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/train_acc.txt', mode='w+',
          encoding='utf-8') as f6:
    for val in train_acc:
        f6.write(str(val))
        f6.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/train_precision.txt', mode='w+',
          encoding='utf-8') as f7:
    for val in train_precision:
        f7.write(str(val))
        f7.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/train_recall.txt', mode='w+',
          encoding='utf-8') as f8:
    for val in train_recall:
        f8.write(str(val))
        f8.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/train_f1.txt', mode='w+',
          encoding='utf-8') as f9:
    for val in train_f1:
        f9.write(str(val))
        f9.write('\n')

with open(file='./results/different_learning_method/easy_to_hard/result/train_time_record.txt', mode='w+',
