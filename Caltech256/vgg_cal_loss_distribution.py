...
'''
@Time    : 2021/7/26 20:50
@Author  : Qiushi Wang
@FileName: new_vgg_cal_loss_distribution.py
@Software: PyCharm
'''
...
train_loss_file = './results/new_cal_loss/vgg_train_loss_file.txt'
...
valid_loss_file = './results/new_cal_loss/vgg_valid_loss_file.txt'
