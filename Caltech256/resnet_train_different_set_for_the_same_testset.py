...
train_dir = ['./results/confusion_dataset/vgg/10_20', './results/confusion_dataset/vgg/20_30',
             './results/confusion_dataset/vgg/30_40', './results/confusion_dataset/vgg/40_50',
             './results/confusion_dataset/vgg/50_60', './results/confusion_dataset/vgg/60_70',
             './results/confusion_dataset/vgg/70_80', './results/confusion_dataset/vgg/80_90',
...
# 将结果写入文本
# with open(file='./results/hard_sample_train/10_100/valid_acc.txt', mode='w+', encoding='utf-8') as f1:
#     for val in valid_acc:
#         f1.write(str(val))
#         f1.write('\n')
#
# with open(file='./results/hard_sample_train/10_100/valid_precision.txt', mode='w+', encoding='utf-8') as f2:
#     for val in valid_precision:
#         f2.write(str(val))
#         f2.write('\n')
#
# with open(file='./results/hard_sample_train/10_100/valid_recall.txt', mode='w+', encoding='utf-8') as f3:
#     for val in valid_recall:
#         f3.write(str(val))
#         f3.write('\n')
#
# with open(file='./results/hard_sample_train/10_100/valid_f1.txt', mode='w+', encoding='utf-8') as f4:
#     for val in valid_f1:
#         f4.write(str(val))
#         f4.write('\n')
#
# with open(file='./results/hard_sample_train/10_100/time_record.txt', mode='w+', encoding='utf-8') as f5:
