...
def train_model(MAX_EPOCH):
    ...
    # ============================ step 1/5 数据 ============================
    train_dir = [
                 './results/confusion_dataset/alexnet/30_40',
                 './results/confusion_dataset/alexnet/40_50',
                 './results/confusion_dataset/alexnet/50_60',
                 './results/confusion_dataset/alexnet/60_70',
