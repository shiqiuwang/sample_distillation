...
@Author  : Qiushi Wang
@FileName: resnet_new_cal_loss_distribution.py
@Software: PyCharm
'''
...
train_loss_file = './results/new_cal_loss/resnet_train_loss_file.txt'
...
valid_loss_file = './results/new_cal_loss/resnet_valid_loss_file.txt'
